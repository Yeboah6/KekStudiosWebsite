                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-8 col-lg-9 col-md-12">
                        <div class="hero__caption hero__caption3 text-center">
                            <h1 data-animation="fadeInLeft" data-delay=".6s">Book Our Services</h1>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="booking-form-wrapper">
                        ...
                        <form class="booking-form" action="" method="POST" id="bookingForm">
                            @csrf
                            
                            <!-- Service Selection -->
                            <div class="row mb-4">
                                <div class="col-12">
                                    <h4 class="form-section-title">1. Select Service</h4>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select form-control" id="service" name="service" required>
                                            ...
                                            <option value="web-mobile-applications">Web & Mobile Applications Development</option>
                                            <option value="ui-ux-design">UI/UX Design</option>
                                            <option value="event-campaign-branding">Event & Campaign Branding</option>
                                            <option value="creative-strategy-consulting">Creative Strategy & Consulting</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="company" name="company" placeholder="Your company (if applicable)">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="project_title" name="project_title" placeholder="Give your project a name" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="project_description" class="form-label">Project Description <span class="text-danger">*</span></label>
                                        <textarea class="form-control" id="project_description" name="project_description" rows="5" placeholder="Describe your project requirements in detail" required></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="budget" class="form-label">Estimated Budget</label>
                                        <select class="form-select form-control" id="budget" name="budget">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select form-control" id="reference" name="reference">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="additional_notes" name="additional_notes" rows="3" placeholder="Any other details you'd like to share"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 text-center">
                                    <button type="submit" class="button boxed-btn btn-lg" style="border-radius: 7px;">Submit Booking Request</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="single-slider d-flex align-items-center slider-height3">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-8 col-lg-9 col-md-12">
                        <div class="hero__caption hero__caption3 text-center">
                            <h1 data-animation="fadeInLeft" data-delay=".6s">Book {{ $service["title"] }}</h1>
                            <p data-animation="fadeInLeft" data-delay=".8s">Let's bring your vision to life</p>
                        </div>
                    </div>
                </div>
                        ...
                        <form class="booking-form" action="" method="POST" id="bookingForm">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 mt-3">
                                    <div class="service-details p-3 bg-light rounded">
                                        <h5>What's included:</h5>
                                        <ul class="list-unstyled mt-2">
                                            @foreach($service['works'] as $work)
                                                <li><i class="fas fa-check text-success me-2"></i> {{ $work }}</li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </div>
